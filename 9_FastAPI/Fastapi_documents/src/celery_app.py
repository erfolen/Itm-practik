...
# result_backend='rpc://root:12345678@rabbit_app:5672/vdata'

celery_app = Celery('task', result_backend='rpc://', broker='amqp://root:12345678@rabbit_app:5672/vdata',
